...
const SurveyList = ({ survey }: { survey: ISurvey }) => {
    ...
    return (
        <div className='card-survey' onClick={redirectSurvey}>
            ...
            <p className='option-survey-list'>1. {survey.options.length !== 0 && survey.options[0].name}</p>
            <p className='option-survey-list'>2. {survey.options.length !== 0 && survey.options[1].name}</p>
